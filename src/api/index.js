...
// 根据栋数和层数筛选寝室
export const findDorm = (tung, layer) => request('/alldormnum', {tung, layer});

// 获取某个寝室历史查寝记录
export const findRecordByDormnum = ({
  dormNum, 
  currentPage, 
  pageSize, 
  state='', 
...
// 发送请求修改已读状态
// export const changeRead = ({}) => request('/changeRead', {});
...
export const insertCheckdorm = (
  ...
  // 学生角色获取查寝记录
  export const stuDorm = (stunum, currentPage, pageSize) => request('/stuDorm', {stunum, currentPage, pageSize});

  // 提交反馈
  // export const sendFeedback = ({}) => request('/sendfeedback', {});
